...
import { Check, Crown, Icon, Star } from "lucide-react";
...
const LessonButton = ({ id, index, totalCount, locked, current, percentage }: Props) => {
    ...
    if (cycleIndex <= 2) {
        ...
        indentationLevel = cycleIndex - 8;   //or cycleLength
    }

    const rightPosition = indentationLevel * 40; //40 gap wise, can change
    ...
    return (
        ...
        >
            <div className={`relative ${isFirst && !isCompleted ? 'mt-[60px]' : 'mt-[24px]'}`} style={{ right: `${rightPosition}px` }}>
                {current ? (
                    <div className="h-[102px] w-[102px] relative">
                        ...
                        <CircularProgressbarWithChildren
                            ...
                            styles={{
                                path: {
                                    stroke: "#4ade80",   //filled
                                },
                                trail: {
                                    stroke: "#e5e7eb",   //unfilled 
                                }
                            }}
                        >
                            <Button
